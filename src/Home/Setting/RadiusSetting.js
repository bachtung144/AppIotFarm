          ...
          <View style={{marginTop:184}}>
              ...
              <View style={{marginTop:55}}>
                  <MultiSlider
                      ...
                      values={[30, 40]} min={10} max={100}
                  />
                  <View style={{flexDirection:'row'}}>
                      <Text style={{flex:1,fontWeight:'bold',
                          fontFamily:'Roboto',fontSize:16}}>2.5m</Text>
                      <Text style={{fontWeight:'bold',
                          fontFamily:'Roboto',fontSize:16}}>3m</Text>
                  </View>
              </View>
              <TouchableOpacity style={{backgroundColor:'#47AA12',height:44.27,alignItems:'center',
              justifyContent:'center',borderRadius:80,marginTop:120}}
                                onPress={() =>navigation.goBack()}
              >
                  <Text style={{fontFamily:'Roboto',fontSize:18,color:'#FFF'}}>LƯU</Text>
              </TouchableOpacity>
          </View>
